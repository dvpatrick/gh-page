...
function Skills() {
  ...
  <section className='skills'>
    ...
    <div className='svgContainer'>
      ...
      <div className='vidro'>
        Mysql / MariaDB
        <img src="https://linuxapt.com/assets/uploads/media-uploader/install-mariadb-linux-mint-20-database-01612720199.png" alt='mysql e mariadb'/>
      </div>
      <div className='vidro'>
        MongoDB
      ...
      <div className='vidro'>
        Bootstrap
        <img src="https://getbootstrap.com.br/docs/4.1/assets/img/bootstrap-stack.png" alt='bootstrap'/>
      </div>
      <div className='vidro'>
        Jest
      ...
      <div className='vidro'>
        Mocha
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mocha/mocha-plain.svg" alt='mocha'/>
      </div>
      <div className='vidro'>
        Chai
        <img src="https://miro.medium.com/max/560/1*9hCO_QRevNSJNFvCKWS7hg.png" alt='chai'/>
      </div>
      <div className='vidro'>
        Git
